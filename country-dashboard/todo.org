...
** Restyle Rickshaw.min.css
   The names of the days in the plot are covered by the plot lines in
   the Compare. Perhaps move below the x-axis (and boldface them?)
   e. Would have been nice to be able to deselect a country from the
   legend.
